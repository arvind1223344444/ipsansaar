...
<!-- Mirrored from gramotech.net/html/balad/news-full.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:14:23 GMT -->
<head>
<meta charset="utf-8">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9 col-sm-8"> 
            <!--News Full Start-->
            <div class="news-box">
              <div class="new-thumb"> <a href="#"><i class="fas fa-link"></i></a> <span class="cat c1">Medical</span> <img src="images/newsfull1.jpg" alt=""> </div>
              <div class="new-txt">
                <ul class="news-meta">
                  <li>30 MAR, 2019</li>
                  <li>176 Comments</li>
                </ul>
                <h6><a href="#">Sed ultricies nibh commodo, molestie orci sit amet justo</a></h6>
                <p> Praesent mauris neque, consequat id orci nec, fermentum bibendum dolor. Maecenas viverra odio nec ligula tempus semper. Suspendisse ornare tellus tortor, a scelerisque turpis viverra eu. </p>
              </div>
            ...
            <!--News Full Start-->
            <div class="news-box">
              <div class="new-thumb"> <a href="#"><i class="fas fa-link"></i></a> <span class="cat c2">HOUSE & FINANCE </span> <img src="images/newsfull2.jpg" alt=""> </div>
              <div class="new-txt">
                <ul class="news-meta">
                  <li>30 MAR, 2019</li>
                  <li>176 Comments</li>
                </ul>
                <h6><a href="#">Nulla elementum orci ac nisl vehicula, sit amet ultricies</a></h6>
                <p>Ut in cursus felis. Duis rhoncus urna vitae arcu faucibus porta. Quisque maximus vitae sem vel euismod. Maecenas non nunc pharetra, molestie sapien in, pulvinar libero. Aliquam scelerisque nulla at leo posuere.</p>
              </div>
              <div class="news-box-f"> <img src="images/user2.jpg" alt=""> Johny Stewart <a href="#"><i class="fas fa-arrow-right"></i></a> </div>
            </div>
            <!--News Full End--> 
            <!--News Full Start-->
            <div class="news-box">
              <div class="new-thumb"> <a href="#"><i class="fas fa-link"></i></a> <span class="cat c3">EDUCATION</span> <img src="images/newsfull3.jpg" alt=""> </div>
              <div class="new-txt">
                <ul class="news-meta">
                  <li>30 MAR, 2019</li>
                  <li>176 Comments</li>
                </ul>
                <h6><a href="#">Aenean euismod dui sit amet, sed luctus lectus imperdiet</a></h6>
                <p> Aenean feugiat volutpat lorem eu lacinia. Vivamus porta leo eros, in lobortis nisl vehicula ut. Aliquam maximus id lacus hendrerit egestas. Ut id libero tortor. Nulla sed risus vel diam tincidunt mattis vel fermentum turpis.</p>
              </div>
              <div class="news-box-f"> <img src="images/user2.jpg" alt=""> Johny Stewart <a href="#"><i class="fas fa-arrow-right"></i></a> </div>
            </div>
            <!--News Full End--> 
            ...
            <div class="news-box">
              ...
              <div class="new-txt">
                ...
                <h6><a href="#">Suspendisse lobortis nulla a, facilisis ultrices quam congue</a></h6>
                <p>Etiam laoreet dolor vel diam bibendum malesuada eu at diam. Nunc fringilla odio at orci sollicitudin, nec tempus tortor lacinia. Vestibulum pretium ac ante nec lacinia. Fusce in est porta velit porta finibus. </p>
              </div>
              <div class="news-box-f"> <img src="images/user2.jpg" alt=""> Johny Stewart <a href="#"><i class="fas fa-arrow-right"></i></a> </div>
            </div>
            <!--News Full End--> 
            <!--News Full Start-->
            <div class="news-box">
              <div class="new-thumb"> <a href="#"><i class="fas fa-link"></i></a> <span class="cat c5">AGRICULTURE</span> <img src="images/newsfull5.jpg" alt=""> </div>
              <div class="new-txt">
                <ul class="news-meta">
                  <li>30 MAR, 2019</li>
                  <li>176 Comments</li>
                </ul>
                <h6><a href="#">Maecenas in ipsum pharetra,  facilisis rhoncus augue</a></h6>
                <p>Morbi vitae ipsum eget libero interdum lobortis. In tincidunt non purus fringilla pretium. Nullam tincidunt turpis vestibulum dapibus feugiat. Pellentesque eget vehicula nunc, eu ultrices nunc.</p>
              </div>
              <div class="news-box-f"> <img src="images/user2.jpg" alt=""> Johny Stewart <a href="#"><i class="fas fa-arrow-right"></i></a> </div>
            </div>
            <!--News Full End-->
          ...
          <div class="col-md-3 col-sm-4">
            <div class="sidebar"> 
              ...
              <div class="widget">
                <h4>About us</h4>
                <div class="about-widget inner"> <img src="images/about-widget-img.jpg" alt="">
              ...
              <div class="widget">
                ...
                <div class="recent-posts inner">
                  <ul>
                    <li> <img src="images/rp1.jpg" alt=""> <strong>28 August, 2019</strong>
                      <h6> <a href="#">Fake News may be worrisome, but the </a> </h6>
                    </li>
                    <li> <img src="images/rp2.jpg" alt=""> <strong>28 August, 2019</strong>
                      <h6> <a href="#">Republic Faces Political Turmoil</a> </h6>
                    </li>
                    <li> <img src="images/rp3.jpg" alt=""> <strong>28 August, 2019</strong>
                ...
                <div class="upcoming-events inner">
                  <ul>
                    <li>
                      ...
                      <span class="loc">150 / G iii, Newyork, USA</span> </li>
                    <li>
                      <div class="edate"> <strong>30</strong> Sep <span class="year">2019</span> </div>
...
<!-- Mirrored from gramotech.net/html/balad/news-full.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:14:39 GMT -->
</html>