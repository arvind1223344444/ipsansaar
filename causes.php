...
<!-- Mirrored from gramotech.net/html/balad/causes.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:16:21 GMT -->
<head>
      <meta charset="utf-8">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="campaign-box">
                           ...
                           <div class="campaign-txt">
                              <h5><a href="#">Children's Health Fund</a> </h5>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="campaign-box">
                           ...
                           <div class="campaign-txt">
                              <h5><a href="#">Save Hungry Children</a> </h5>
                              <ul class="participants">
                                 <li><img src="images/u1.jpg" alt=""></li>
                                 <li><img src="images/u2.jpg" alt=""></li>
                                 <li><img src="images/u3.jpg" alt=""></li>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="campaign-box">
                           ...
                           <div class="campaign-txt">
                              <h5><a href="#">Help For Handicapped Child</a> </h5>
                              <ul class="participants">
                                 <li><img src="images/u1.jpg" alt=""></li>
                                 <li><img src="images/u2.jpg" alt=""></li>
                                 <li><img src="images/u3.jpg" alt=""></li>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="campaign-box">
                           <div class="campaign-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/fc4.jpg" alt=""> </div>
                           <div class="campaign-txt">
                              <h5><a href="#">Education to Every Child</a> </h5>
                              <ul class="participants">
                                 <li><img src="images/u1.jpg" alt=""></li>
                                 <li><img src="images/u2.jpg" alt=""></li>
                                 <li><img src="images/u3.jpg" alt=""></li>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="campaign-box">
                           <div class="campaign-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/fc5.jpg" alt=""> </div>
                           <div class="campaign-txt">
                              <h5><a href="#">Donate For Drinking Water</a> </h5>
                              <ul class="participants">
                                 <li><img src="images/u1.jpg" alt=""></li>
                                 <li><img src="images/u2.jpg" alt=""></li>
                                 <li><img src="images/u3.jpg" alt=""></li>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="campaign-box">
                           <div class="campaign-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/fc6.jpg" alt=""> </div>
                           <div class="campaign-txt">
                              <h5><a href="#">Adopt Child From Asia</a> </h5>
                              <ul class="participants">
                                 <li><img src="images/u1.jpg" alt=""></li>
                                 <li><img src="images/u2.jpg" alt=""></li>
                                 <li><img src="images/u3.jpg" alt=""></li>
...
<!-- Mirrored from gramotech.net/html/balad/causes.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:16:38 GMT -->
</html>