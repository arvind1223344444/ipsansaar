...
<!-- Mirrored from gramotech.net/html/balad/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:15:55 GMT -->
<head>
      <meta charset="utf-8">
   ...
   <body>
      ...
      <div class="wrapper">
         ...
         <div class="main-content p80">
            <!--Services Start-->
            <div class="wf100 local-services">
               <div class="container">
                  <div class="row">
                     <!--Services Box Start-->
                     <div class="col-md-4 col-sm-6">
                        <div class="service-box">
                           <div class="serbox-cap">
                              <h6><a href="#">City History,<br>
                                 Culture & Heritage </a> 
                              </h6>
                              <p> Nam turpis justo, placerat sed eleifend quis, hendrerit id metus Integer eleifend. </p>
                              <a href="#" class="rm">Read More</a> 
                           </div>
                           <img src="images/govt-sercices1.jpg" alt=""> 
                        </div>
                     </div>
                     <!--Services Box End--> 
                     <!--Services Box Start-->
                     <div class="col-md-4 col-sm-6">
                        <div class="service-box">
                           <div class="serbox-cap">
                              <h6><a href="#">Government<br>
                                 Economy </a> 
                              </h6>
                              <p> Nam turpis justo, placerat sed eleifend quis, hendrerit id metus Integer eleifend. </p>
                              <a href="#" class="rm">Read More</a> 
                           </div>
                           <img src="images/govt-sercices2.jpg" alt=""> 
                        </div>
                     </div>
                     <!--Services Box End--> 
                     <!--Services Box Start-->
                     <div class="col-md-4 col-sm-6">
                        <div class="service-box">
                           <div class="serbox-cap">
                              <h6><a href="#">Constitution & <br>
                                 Government Laws</a> 
                              </h6>
                              <p> Nam turpis justo, placerat sed eleifend quis, hendrerit id metus Integer eleifend. </p>
                              <a href="#" class="rm">Read More</a> 
                           </div>
                           <img src="images/govt-sercices3.jpg" alt=""> 
                        </div>
                     </div>
                     <!--Services Box End-->
                     <!--Services Box Start-->
                     <div class="col-md-4 col-sm-6">
                        <div class="service-box">
                           <div class="serbox-cap">
                              <h6><a href="#">Know About<br>
                                 The Citizens Rights</a> 
                              </h6>
                              <p> Nam turpis justo, placerat sed eleifend quis, hendrerit id metus Integer eleifend. </p>
                              <a href="#" class="rm">Read More</a> 
                           </div>
                           <img src="images/govt-sercices4.jpg" alt=""> 
                        </div>
                     </div>
                     <!--Services Box End-->
                     <!--Services Box Start-->
                     <div class="col-md-4 col-sm-6">
                        <div class="service-box">
                           <div class="serbox-cap">
                              <h6><a href="#">Business & <br>
                                 Administrations</a> 
                              </h6>
                              <p> Nam turpis justo, placerat sed eleifend quis, hendrerit id metus Integer eleifend. </p>
                              <a href="#" class="rm">Read More</a> 
                           </div>
                           <img src="images/govt-sercices5.jpg" alt=""> 
                        </div>
                     </div>
                     <!--Services Box End-->
                     <!--Services Box Start-->
                     <div class="col-md-4 col-sm-6">
                        <div class="service-box">
                           <div class="serbox-cap">
                              <h6><a href="#">Education & <br>
                                 Public Library</a> 
                              </h6>
                              <p> Nam turpis justo, placerat sed eleifend quis, hendrerit id metus Integer eleifend. </p>
                              <a href="#" class="rm">Read More</a> 
                           </div>
                           <img src="images/govt-sercices6.jpg" alt=""> 
                        </div>
                     </div>
                     <!--Services Box End-->
                     <!--Services Box Start-->
                     <div class="col-md-4 col-sm-6">
                        <div class="service-box">
                           <div class="serbox-cap">
                              <h6><a href="#">Govt. Budget & <br>
                                 Policies</a> 
                              </h6>
                              <p> Nam turpis justo, placerat sed eleifend quis, hendrerit id metus Integer eleifend. </p>
                              <a href="#" class="rm">Read More</a> 
                           </div>
                           <img src="images/govt-sercices7.jpg" alt=""> 
                        </div>
                     </div>
                     <!--Services Box End-->
                     <!--Services Box Start-->
                     <div class="col-md-4 col-sm-6">
                        <div class="service-box">
                           <div class="serbox-cap">
                              <h6><a href="#">Govt. International <br>
                                 Current Affairs</a> 
                              </h6>
                              <p> Nam turpis justo, placerat sed eleifend quis, hendrerit id metus Integer eleifend. </p>
                              <a href="#" class="rm">Read More</a> 
                           </div>
                           <img src="images/govt-sercices8.jpg" alt=""> 
                        </div>
                     </div>
                     <!--Services Box End-->
                     <!--Services Box Start-->
                     <div class="col-md-4 col-sm-6">
                        <div class="service-box">
                           <div class="serbox-cap">
                              <h6><a href="#">Money Transfer & <br>
                                 Tax Payments</a> 
                              </h6>
                              <p> Nam turpis justo, placerat sed eleifend quis, hendrerit id metus Integer eleifend. </p>
                              <a href="#" class="rm">Read More</a> 
                           </div>
                           <img src="images/govt-sercices9.jpg" alt=""> 
                        </div>
                     </div>
                     <!--Services Box End-->
...
<!-- Mirrored from gramotech.net/html/balad/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:16:10 GMT -->
</html>