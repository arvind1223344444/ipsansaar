...
<!-- Mirrored from gramotech.net/html/balad/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:15:08 GMT -->
<head>
      <meta charset="utf-8">
   ...
   <body>
      ...
      <div class="wrapper">
         ...
         <section class="wf100 subheader">
            <div class="container">
               <h2>Upcoming Events in the City</h2>
               <ul>
                  <li> <a href="index-2.html">Home</a> </li>
                  <li> <a href="#"> Events </a> </li>
                  <li>Events Grid Style</li>
               </ul>
            </div>
         </section>
         <!--Sub Header End--> 
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="event-post">
                           <div class="thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/event-img2.jpg" alt=""></div>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="event-post">
                           <div class="thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/event-img1.jpg" alt=""></div>
                           <div class="event-post-content">
                              <div class="event-post-txt">
                                 ...
                                 <p>Festivals and events play an integral role in shaping and building our communities.</p>
                              </div>
                              <div class="event-post-loc"> <i class="fas fa-map-marker-alt"></i> Millenia Orlando, USA <a href="#"><i class="fas fa-arrow-right"></i></a> </div>
                           </div>
                        </div>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="event-post">
                           <div class="thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/event-img3.jpg" alt=""></div>
                           <div class="event-post-content">
                              <div class="event-post-txt">
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="event-post">
                           <div class="thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/event-img4.jpg" alt=""></div>
                           <div class="event-post-content">
                              <div class="event-post-txt">
                                 <h5><a href="#">New Year Cultural Fest</a></h5>
                                 <ul class="event-meta">
                                    <li><i class="far fa-calendar-alt"></i> 3-5 March, 2019</li>
                                    <li><i class="far fa-clock"></i> 09:00am - 06:00pm</li>
                                 </ul>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="event-post">
                           <div class="thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/event-img5.jpg" alt=""></div>
                           <div class="event-post-content">
                              <div class="event-post-txt">
                                 <h5><a href="#">Annual Cycling Race</a></h5>
                                 <ul class="event-meta">
                                    <li><i class="far fa-calendar-alt"></i> 3-5 March, 2019</li>
                                    <li><i class="far fa-clock"></i> 09:00am - 06:00pm</li>
                                 </ul>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="event-post">
                           <div class="thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/event-img6.jpg" alt=""></div>
                           <div class="event-post-content">
                              <div class="event-post-txt">
...
<!-- Mirrored from gramotech.net/html/balad/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:15:19 GMT -->
</html>