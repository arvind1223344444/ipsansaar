...
<!-- Mirrored from gramotech.net/html/balad/causes-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:16:38 GMT -->
<head>
      <meta charset="utf-8">
                  ...
                  <div class="row">
                     <div class="col-md-9">
                        ...
                        <div class="campaign-box">
                           <div class="campaign-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/cl1.jpg" alt=""> </div>
                           <div class="campaign-txt">
                              <h4><a href="#">Health Funds For Children</a>
                              </h4>
                              ...
                              <ul class="funds">
                                 <li class="text-left"><strong>47%</strong> Funded</li>
                                 <li class="text-center"><strong>$638.00</strong> Raised</li>
                                 <li class="text-right"><strong>$9750.00</strong> Required</li>
                              </ul>
                              <a href="#" class="dn-btn">Donate Now</a> 
                           </div>
                        </div>
                        <!--Cause end -->
                        <!--Cause start -->
                        <div class="campaign-box">
                           <div class="campaign-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/cl2.jpg" alt=""> </div>
                           <div class="campaign-txt">
                              <h4><a href="#">Save Hungry Children</a>
                              </h4>
                              <ul class="participants">
                                 <li><img src="images/u1.jpg" alt=""></li>
                                 <li><img src="images/u2.jpg" alt=""></li>
                        ...
                        <!--Cause start -->
                        <div class="campaign-box">
                           <div class="campaign-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/cl3.jpg" alt=""> </div>
                           <div class="campaign-txt">
                              <h4><a href="#">Help For Handicapped Child</a>
                              </h4>
                              <ul class="participants">
                                 <li><img src="images/u1.jpg" alt=""></li>
                                 <li><img src="images/u2.jpg" alt=""></li>
                        ...
                        <!--Cause start -->
                        <div class="campaign-box">
                           <div class="campaign-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/cl4.jpg" alt=""> </div>
                           <div class="campaign-txt">
                              <h4><a href="#">Education to EveryOne</a>
                              </h4>
                              <ul class="participants">
                                 <li><img src="images/u1.jpg" alt=""></li>
                                 <li><img src="images/u2.jpg" alt=""></li>
                        ...
                        <!--Cause start -->
                        <div class="campaign-box">
                           <div class="campaign-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/cl5.jpg" alt=""> </div>
                           <div class="campaign-txt">
                              <h4><a href="#">Donate For Drinking Water</a>
                              </h4>
                              <ul class="participants">
                                 <li><img src="images/u1.jpg" alt=""></li>
                                 <li><img src="images/u2.jpg" alt=""></li>
...
<!-- Mirrored from gramotech.net/html/balad/causes-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:16:47 GMT -->
</html>