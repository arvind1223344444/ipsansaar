...
<!-- Mirrored from gramotech.net/html/balad/team-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:17:07 GMT -->
<head>
      <meta charset="utf-8">
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="team-box">
                           <div class="team-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/team1.jpg" alt=""></div>
                           <div class="team-txt">
                              <h5>Danny Richard</h5>
                              <strong class="dep">Task Force Chief</strong>
                              <p>Danny Richard has the main task force command in multiple security companies.</p>
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="team-box">
                           <div class="team-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/team2.jpg" alt=""></div>
                           <div class="team-txt">
                              <h5>Stephen Paul</h5>
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="team-box">
                           <div class="team-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/team3.jpg" alt=""></div>
                           <div class="team-txt">
                              <h5>Harry Wilson</h5>
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="team-box">
                           <div class="team-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/team4.jpg" alt=""></div>
                           <div class="team-txt">
                              <h5>James Scott</h5>
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="team-box">
                           <div class="team-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/team5.jpg" alt=""></div>
                           <div class="team-txt">
                              <h5>Alex Joe</h5>
                              <strong class="dep">Task Force Chief</strong>
                              <p> Danny Richard has the main task force command in multiple security companies. </p>
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="team-box">
                           <div class="team-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/team6.jpg" alt=""></div>
                           <div class="team-txt">
                              <h5>Waynes Davies</h5>
                              <strong class="dep">Assistant Mayor</strong>
                              <p> Stephen Paul is very Compitent and very agile person who assist to Mayor of the City. </p>
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="team-box">
                           <div class="team-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/team7.jpg" alt=""></div>
                           <div class="team-txt">
                              <h5>Alan Barry</h5>
                              <strong class="dep">Health Minister</strong>
                              <p> Harry Wilson is Minister of Health Department, look after all matters related health in the city. </p>
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="team-box">
                           <div class="team-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/team8.jpg" alt=""></div>
                           <div class="team-txt">
                              <h5>Taylor Jone</h5>
                              <strong class="dep">Marketing Coordinator</strong>
                              <p> James Scott is very strong person who coordinate in all the events and marketing strategies. </p>
...
<!-- Mirrored from gramotech.net/html/balad/team-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:17:12 GMT -->
</html>