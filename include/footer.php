  ...
  <!--Footer Start-->
  <footer class="home3 main-footer wf100 pt-0">
    <div class="container">
      <div class="row"> 
        <!--Footer Widget Start-->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7 col-sm-7">
          <p class="copyr">All  Rights Reserved © 2022, By: <a href="#">Ipsansaar.com</a></p>
        </div>
...
<nav id="sidebar">
  ...
  <ul class="list-unstyled components">
    ...
    <li> <a href="explore-city.php">Explore City</a> </li>
