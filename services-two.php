...
<!-- Mirrored from gramotech.net/html/balad/services-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:16:10 GMT -->
<head>
      <meta charset="utf-8">
   ...
   <body>
      ...
      <div class="wrapper">
         ...
         <div class="main-content">
            <!--Services Start-->
            <div class="wf100 p80-50 local-services pagebg2">
               <div class="container">
                  <div class="row">
                     <!--Services Box Start-->
                     <div class="col-md-4 col-sm-6">
                        <div class="deprt-icon-box">
                           ...
                           <h5> <a href="#">History &amp; Establishment</a> </h5>
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="deprt-icon-box">
                           ...
                           <h5> <a href="#">Government Economy</a> </h5>
                           <a class="rm" href="#">Read More</a> 
                        </div>
                     </div>
                     <!--Services Box End--> 
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="deprt-icon-box">
                           ...
                           <h5> <a href="#">Constitution &amp; Government Law</a> </h5>
                           <a class="rm" href="#">Read More</a> 
                        </div>
                     </div>
                     <!--Services Box End--> 
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="deprt-icon-box">
                           <img src="images/deprticon5.png" alt="">
                           <h5> <a href="#">Business &amp;
                              Administrations</a> 
                           </h5>
                           <a class="rm" href="#">Read More</a> 
                     ...
                     <div class="col-md-4 col-sm-6">
                        <div class="deprt-icon-box">
                           <img src="images/deprticon6.png" alt="">
                           <h5> <a href="#">Budget &amp;
                              Govt. Policies</a> 
                           </h5>
                           <a class="rm" href="#">Read More</a> 
            ...
            <!--Services End-->
            <section class="wf100 service-page-bottom">
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-3 col-sm-4">
                        <ul class="reports">
                           ...
                           <li> <a href="#"><i class="fas fa-file-alt"></i> Govt. Dues Defaulter List</a> </li>
                        </ul>
