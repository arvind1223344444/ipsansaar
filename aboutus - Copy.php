...
<!-- Mirrored from gramotech.net/html/balad/aboutus.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:13:43 GMT -->
<head>
      <meta charset="utf-8">
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-4 col-sm-5">
                        <!--Mayor Msg Start-->
                        <div class="city-tour gallery"> <strong> vibrant city </strong> <a href="http://youtu.be/VVvgm7AhFc8" data-rel="prettyPhoto" title="City Tour"><img src="images/playicon.png" alt=""></a> <img src="images/cityvideobg.jpg" alt=""> </div>
                        <!--Mayor Msg End--> 
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-3 col-sm-3">
                        <div class="deprt-icon-box">
                           <img src="images/deprticon1.png" alt="">
                     ...
                     <div class="col-md-3 col-sm-3">
                        <div class="deprt-icon-box">
                           <img src="images/deprticon2.png" alt="">
                     ...
                     <div class="col-md-3 col-sm-3">
                        <div class="deprt-icon-box">
                           <img src="images/deprticon3.png" alt="">
                     ...
                     <div class="col-md-3 col-sm-3">
                        <div class="deprt-icon-box">
                           <img src="images/deprticon4.png" alt="">
               ...
               <div class="container">
                  ...
                  <ul>
                     <li>
                        ...
                        <strong>20,980,150</strong> <span>Population</span> 
                     </li>
                     <li>
                        <div class="facts-icon"><i class="fas fa-map-marked-alt"></i></div>
                        <strong>65,755</strong> <span>Square Miles</span> 
                     </li>
                     <li>
                        <div class="facts-icon"><i class="fas fa-chart-line"></i></div>
                        <strong>$1.00 T</strong> <span>Economy Rate</span> 
                     </li>
                     <li>
                        <div class="facts-icon"><i class="fas fa-hospital"></i></div>
                        <strong>257</strong> <span>Hospitals</span> 
                     </li>
                     <li>
                        <div class="facts-icon"><i class="fas fa-hiking"></i></div>
                        <strong>10.0 M</strong> <span>Tours Visits</span> 
                     </li>
                  </ul>
               </div>
            </section>
...
<!-- Mirrored from gramotech.net/html/balad/aboutus.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:13:50 GMT -->
</html>