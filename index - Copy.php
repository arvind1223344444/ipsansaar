...
<!-- Mirrored from gramotech.net/html/balad/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:06:09 GMT -->
<head>
<meta charset="utf-8">
    ...
    <div class="h3-logo-row wf100">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4">
            <div class="h3-logo"> <a href="index-2.html"><img src="images/h3logo.png" alt=""></a></div>
          </div>
          <div class="col-md-4 col-sm-4">
            <ul class="header-contact">
              <li><span>Toll Free:</span> <strong>0800 12345</strong></li>
    ...
    <div class="home2-slider rev_slider_wrapper"> 
      ...
      <div class="rev_slider_wrapper fullwidthbanner-container">
        <div id="rev-slider2" class="rev_slider fullwidthabanner">
          <ul>
            <li data-transition="fade"> <img src="images/h3-slide1.jpg"  alt="" width="1920" height="685" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
            ...
            <li data-transition="slidehorizontal"> <img src="images/h3-slide2.jpg"  alt="" width="1920" height="685" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
              <div class="tp-caption  tp-resizeme"
							data-x="left" data-hoffset="400" 
							data-y="top" data-voffset="175" 
							data-transform_idle="o:1;"         
              ...
              <div class="tp-caption  tp-resizeme" 
							...
							data-splitout="none"
							data-start="700">
                <div class="slide-content-box"> <a href="#" class="con">Learn More</a> </div>
              </div>
            </li>
            <li data-transition="slidevertical"> <img src="images/h3-slide3.jpg"  alt="" width="1920" height="685" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
              <div class="tp-caption  tp-resizeme" 
							data-x="left" data-hoffset="400" 
							data-y="top" data-voffset="175" 
							data-transform_idle="o:1;"         
        ...
        <div class="row"> 
          ...
          <div class="col-md-3 col-sm-6">
            <div class="news-box">
              ...
              <div class="news-box-f"> <img src="images/tuser1.jpg" alt=""> Johny Stewart <a href="#"><i class="fas fa-arrow-right"></i></a> </div>
            </div>
          </div>
          <!--News Box End--> 
          <!--News Box Start-->
          <div class="col-md-3  col-sm-6">
            <div class="news-box">
              ...
              <div class="new-txt">
                ...
                <h6><a href="#">Integer mollis urna et egestas pretium</a></h6>
                <p> How all this mistaken idea of denounce pleasure and praising pain was born I will give you an. </p>
              </div>
              <div class="news-box-f"> <img src="images/tuser2.jpg" alt=""> Mathew Dan <a href="#"><i class="fas fa-arrow-right"></i></a> </div>
            </div>
          </div>
          <!--News Box End--> 
          <!--News Box Start-->
          <div class="col-md-3  col-sm-6">
            <div class="news-box">
              ...
              <div class="new-txt">
                ...
                <h6><a href="#">In ut erat in  dictum a et purus</a></h6>
                <p> How all this mistaken idea of denounce pleasure and praising pain was born I will give you an. </p>
              </div>
              <div class="news-box-f"> <img src="images/tuser3.jpg" alt=""> Smith Jones <a href="#"><i class="fas fa-arrow-right"></i></a> </div>
            </div>
          </div>
          <!--News Box End--> 
          <!--News Box Start-->
          <div class="col-md-3  col-sm-6">
            <div class="news-box">
              ...
              <div class="new-txt">
                ...
                <h6><a href="#">Cras accumsan mauris eget massa</a></h6>
                <p> How all this mistaken idea of denounce pleasure and praising pain was born I will give you an. </p>
              </div>
              <div class="news-box-f"> <img src="images/user2.jpg" alt=""> Nathan Taylor <a href="#"><i class="fas fa-arrow-right"></i></a> </div>
            </div>
          </div>
          <!--News Box End--> 
        </div>
        ...
        <div class="row">
          <div class="col-md-9">
            ...
            <div class="row"> 
              <!--Icon Box Start-->
              <div class="col-md-4 col-sm-4">
                <div class="deprt-icon-box"> <img src="images/deprticon1.png" alt="">
                  <h6> <a href="#">History & Establishment</a> </h6>
                  <a class="rm" href="#">Read More</a> </div>
              </div>
              <!--Icon Box End--> 
              <!--Icon Box Start-->
              <div class="col-md-4 col-sm-4">
                <div class="deprt-icon-box"> <img src="images/deprticon2.png" alt="">
                  <h6> <a href="#">Government Economy</a> </h6>
                  <a class="rm" href="#">Read More</a> </div>
              </div>
              <!--Icon Box End--> 
              <!--Icon Box Start-->
              <div class="col-md-4 col-sm-4">
                <div class="deprt-icon-box"> <img src="images/deprticon3.png" alt="">
                  <h6> <a href="#">Constitution & Government Law</a> </h6>
                  <a class="rm" href="#">Read More</a> </div>
              </div>
              <!--Icon Box End--> 
              <!--Icon Box Start-->
              <div class="col-md-4 col-sm-4">
                <div class="deprt-icon-box"> <img src="images/deprticon4.png" alt="">
                  <h6> <a href="#">International
                    & Current Affairs </a> </h6>
                  <a class="rm" href="#">Read More</a> </div>
              </div>
              <!--Icon Box End--> 
              <!--Icon Box Start-->
              <div class="col-md-4 col-sm-4">
                <div class="deprt-icon-box"> <img src="images/deprticon5.png" alt="">
                  <h6> <a href="#">Business &
                    Administrations</a> </h6>
                  <a class="rm" href="#">Read More</a> </div>
              </div>
              <!--Icon Box End--> 
              <!--Icon Box Start-->
              <div class="col-md-4 col-sm-4">
                <div class="deprt-icon-box"> <img src="images/deprticon6.png" alt="">
                  <h6> <a href="#">Budget &
                    Govt. Policies</a> </h6>
                  <a class="rm" href="#">Read More</a> </div>
              </div>
              ...
              <div class="recent-event-slider">
                <div class="event-big">
                  <div class="event-cap">
                    ...
                    <p> Sed nec vehicula est. Sed eget sodales mauris. Class aptent taciti sociosqu ad litora torquent per conubia. </p>
                  </div>
                  <img src="images/rec-event1.jpg" alt=""> </div>
                <div class="event-big">
                  <div class="event-cap">
                    <h5><a href="#">2K18 Night Celebration</a></h5>
                    <ul>
                    ...
                    <p> Sed nec vehicula est. Sed eget sodales mauris. Class aptent taciti sociosqu ad litora torquent per. </p>
                  </div>
                  <img src="images/rec-event2.jpg" alt=""> </div>
                <div class="event-big">
                  <div class="event-cap">
                    <h5><a href="#">2K18 Night Celebration</a></h5>
                    <ul>
                  ...
                  <img src="images/rec-event3.jpg" alt=""> </div>
                <div class="event-big">
                  <div class="event-cap">
                    <h5><a href="#">2K18 Night Celebration</a></h5>
                    <ul>
                  ...
                  <img src="images/rec-event4.jpg" alt=""> </div>
              </div>
            ...
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane active" id="Events"> 
                ...
                <ul class="event-list">
                  ...
                  <li><img src="images/upce-1.jpg" alt=""></li>
                  <li class="el-title">
                    <h6><a href="#">Annual Cycling 2019 for Charity Donation</a></h6>
                ...
                <ul class="event-list">
                  <li> <strong class="edate">30 Jan, 2019</strong> <strong class="etime">09:00 pm</strong> </li>
                  <li><img src="images/upce-2.jpg" alt=""></li>
                  <li class="el-title">
                ...
                <ul class="event-list">
                  <li> <strong class="edate">30 Jan, 2019</strong> <strong class="etime">09:00 pm</strong> </li>
                  <li><img src="images/upce-3.jpg" alt=""></li>
                  <li class="el-title">
                ...
                <ul class="event-list">
                  <li> <strong class="edate">30 Jan, 2019</strong> <strong class="etime">09:00 pm</strong> </li>
                  <li><img src="images/upce-4.jpg" alt=""></li>
                  <li class="el-title">
            ...
            <div id="h3team-slider" class="owl-carousel owl-theme"> 
              ...
              <div class="item">
                <div class="h3-team-box">
                  ...
                  <img src="images/h3-team1.jpg" alt=""> </div>
              </div>
              <!--Team Box Start--> 
              <!--Team Box Start-->
              <div class="item">
                <div class="h3-team-box">
                  ...
                  <img src="images/h3-team2.jpg" alt=""> </div>
              </div>
              <!--Team Box Start--> 
              <!--Team Box Start-->
              <div class="item">
          ...
          <div class="textwidget"> <img src="images/footer-logo2.png" alt="">
            ...
            <ul>
              <li> <i class="fas fa-university"></i> <strong>Council Address:</strong> Block H, Cosmo Avenue, #201
                New York, USA </li>
              <li> <i class="fas fa-envelope"></i> <strong>Email:</strong> contact@balad.com<br>
                info@balad.com </li>
...
<!-- Mirrored from gramotech.net/html/balad/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:08:59 GMT -->
</html>