...
<!-- Mirrored from gramotech.net/html/balad/aboutus-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:13:50 GMT -->
<head>
      <meta charset="utf-8">
   ...
   <body>
      ...
      <div class="wrapper">
         ...
         <div class="main-content">
                  ...
                  <div class="row">
                     <div class="col-md-8 col-sm-7">
                        <div class="Mayor-welcome">
                           ...
                           <h6>Edward Robert</h6>
                           <strong>Mayor of the City</strong> 
                        </div>
                     </div>
                     <div class="col-md-4 col-sm-5">
                        <!--Mayor Msg Start-->
                        <div class="city-tour gallery"> <strong> Mayor of City </strong> <a href="http://youtu.be/VVvgm7AhFc8" data-rel="prettyPhoto" title="City Tour"><img src="images/playicon.png" alt=""></a> <img src="images/h3mayer.jpg" alt=""> </div>
                        <!--Mayor Msg End--> 
                     </div>
                  </div>
               </div>
            ...
            <div class="cityscape-sidebar wf100 p80">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                     ...
                     <div class="col-md-3">
                        ...
                        <a href="#" class="jobs-link">View open Vacancies</a>
                        <ul class="reports">
               ...
               <div class="container">
                  ...
                  <div class="row">
                     <div class="col-md-4 col-sm-4">
                        <div class="latest-updates">
                           ...
                           <ul>
                              ...
                              <li> <strong><a href="#">Quisque rhoncus urna hendrerit, bibendum podio non rhoncus est.</a></strong> <span class="post-date"><i class="far fa-calendar-alt"></i> 27 March, 2019</span> </li>
                     ...
                     <div class="col-md-4 col-sm-4">
                        <!--News Post Start-->
                        <div class="event-post">
                           <div class="thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/health.jpg" alt=""> </div>
                           <div class="event-post-txt">
                              <h5><a href="#">Health Care Seminar</a></h5>
                              <ul class="event-meta">
                                 <li><i class="far fa-calendar-alt"></i> 3-5 March, 2019</li>
                                 <li><i class="far fa-clock"></i> 09:00am - 06:00pm</li>
                              </ul>
...
<!-- Mirrored from gramotech.net/html/balad/aboutus-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:14:00 GMT -->
</html>