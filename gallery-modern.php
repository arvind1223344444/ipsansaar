...
<!-- Mirrored from gramotech.net/html/balad/gallery-modern.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:17:59 GMT -->
<head>
      <meta charset="utf-8">
                  ...
                  <div class="row">
                     <div class="portfolio filter-gallery">
                        <div id="filters" class="button-group">
                           ...
                           <button class="button" data-filter=".f1">Business & Work</button>
                           <button class="button" data-filter=".f2">Art & Culture</button>
                           <button class="button" data-filter=".f3">Public</button>
                           <button class="button" data-filter=".f4">Sports</button>
                        </div>
                        <div class="clearfix"></div>
                        <div class="isotope items">
                           <div class="item f1">
                              <div class="gallery-thumb"> <a href="images/gallery/gmasnry1.jpg" data-rel="prettyPhoto[gallery]"><i class="fas fa-search"></i></a> <img src="images/gallery/gmasnry1.jpg" alt=""> </div>
                           </div>
                           <div class="item f2">
                              <div class="gallery-thumb"> <a href="images/gallery/gmasnry2.jpg" data-rel="prettyPhoto[gallery]"><i class="fas fa-search"></i></a> <img src="images/gallery/gmasnry2.jpg" alt=""> </div>
                           </div>
                           <div class="item height2 f3">
                              <div class="gallery-thumb"> <a href="images/gallery/gmasnry3.jpg" data-rel="prettyPhoto[gallery]"><i class="fas fa-search"></i></a> <img src="images/gallery/gmasnry3.jpg" alt=""> </div>
                           </div>
                           <div class="item width2 f1">
                              <div class="gallery-thumb"> <a href="images/gallery/gmasnry4.jpg" data-rel="prettyPhoto[gallery]"><i class="fas fa-search"></i></a> <img src="images/gallery/gmasnry4.jpg" alt=""> </div>
                           </div>
                           <div class="item f2">
                              <div class="gallery-thumb"> <a href="images/gallery/gmasnry5.jpg" data-rel="prettyPhoto[gallery]"><i class="fas fa-search"></i></a> <img src="images/gallery/gmasnry5.jpg" alt=""> </div>
                           </div>
                           <div class="item f3">
                              <div class="gallery-thumb"> <a href="images/gallery/gmasnry6.jpg" data-rel="prettyPhoto[gallery]"><i class="fas fa-search"></i></a> <img src="images/gallery/gmasnry6.jpg" alt=""> </div>
                           </div>
                           <div class="item f3">
                              <div class="gallery-thumb"> <a href="images/gallery/gmasnry7.jpg" data-rel="prettyPhoto[gallery]"><i class="fas fa-search"></i></a> <img src="images/gallery/gmasnry7.jpg" alt=""> </div>
                           </div>
                           <div class="item height2 f4">
                              <div class="gallery-thumb"> <a href="images/gallery/gmasnry11.jpg" data-rel="prettyPhoto[gallery]"><i class="fas fa-search"></i></a> <img src="images/gallery/gmasnry11.jpg" alt=""> </div>
                           </div>
                           <div class="item width2 f4">
                              <div class="gallery-thumb"> <a href="images/gallery/gmasnry10.jpg" data-rel="prettyPhoto[gallery]"><i class="fas fa-search"></i></a> <img src="images/gallery/gmasnry10.jpg" alt=""> </div>
                           </div>
                           <div class="item f4">
                              <div class="gallery-thumb"> <a href="images/gallery/gmasnry8.jpg" data-rel="prettyPhoto[gallery]"><i class="fas fa-search"></i></a> <img src="images/gallery/gmasnry8.jpg" alt=""> </div>
                           </div>
                           <div class="item f4">
                              <div class="gallery-thumb"> <a href="images/gallery/gmasnry9.jpg" data-rel="prettyPhoto[gallery]"><i class="fas fa-search"></i></a> <img src="images/gallery/gmasnry9.jpg" alt=""> </div>
                           </div>
                        </div>
                     </div>
                  </div>
...
<!-- Mirrored from gramotech.net/html/balad/gallery-modern.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 12:18:16 GMT -->
</html>